...
export const institutes = [
  {
    ...
    alt: 'Nuces image',
    role: "Bachelor's Degree in Computer Science with specialization in Cyber Security",
...
export const newContent = [
  {
    text: 'Contributing in Open-Source projects',

  },
  {
    text: 'Focusing on Web3',
    showNewTag: true
  },
  {
    text: 'Started Learning Java',
  }
];
